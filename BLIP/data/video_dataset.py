...
class VideoDataset(Dataset):
    ...
    def __init__(self, video_root, ann_root, num_frm=4, frm_sampling_strategy="rand", max_img_size=384, video_fmt='.mp4'):
        ...
        '''        
        filename = 'all_filtered_data_simple.json'
        ...
        self.text = [pre_caption(ann['sentences'],40) for ann in self.annotation]
    ...
    def __getitem__(self, index):
        ...
        video_path = os.path.join(self.video_root, str(index) + self.video_fmt) 
